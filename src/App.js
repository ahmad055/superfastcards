...
import TheCollection from "./Components/Shop/TheCollection";
...
function App() {
  return (
    <div className="App">
      ...
      <Route path="/garageNFTCollections" element={<GarageNFTCollections />}/>
      ...
      <Route path="/carbonleathercollection" element={<Carbonleathercollection/>}/>
