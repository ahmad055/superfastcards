            ...
            >
              <ul className="navbar-nav ">
                <li className="nav-item  ">
                  <NavLink active="menu_active" className="nav-link" to="/games">
                    THE GAMES
                  </NavLink>
                </li>
                <li className="nav-item">
                  <NavLink active="menu_active" className="nav-link" to="/shop">
                    THE COLLECTIONS
                  </NavLink>
                </li>
                <li className="nav-item">
                  <NavLink active="menu_active" className="nav-link" to="/roadmap">
                    THE ROADMAP
                  </NavLink>
                </li>
                <li className="nav-item ">
                  <NavLink active="menu_active" className="nav-link" to="/faq">
                    FAQ
                  </NavLink>
                </li>
                <li className="nav-item  ">
                  <NavLink active="menu_active" className="nav-link p-c-link" to="/garage">
                    YOUR GARAGE
                  </NavLink>
                </li>
                <li className="nav-item ">
