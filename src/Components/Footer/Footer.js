...
const Footer = () => {
  return (
    <div className='bg-black footer py-5'>
        ...
        <div className='d-flex justify-content-center mt-3'>
            <p className='footer-p'>© superfast.cards 2021-2022</p>
        </div>
        <div className='d-flex justify-content-center mt-3'>
            <p className='footer-p'>Get in touch via discord or via <span hred="/founders@superfast.cards" className='ms-1'> founders@superfast.cards</span></p>
        </div>
        <div className='d-flex justify-content-center '>
        ...
        <a><FaInstagram className='footer-icon mx-2' /></a>
