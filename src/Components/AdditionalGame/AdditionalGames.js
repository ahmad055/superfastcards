                ...
                <div className="col-lg-6 d-flex justify-content-center ">
                  <div className="a-d-card mt-5 ">
                    <div className="d-flex mt-4 ms-4 ">
                      <div className="upper-rotate-div text-center flex-column  ">Your daily chance to win a 
                      <span>SUPERFAST.CARDS NFT!</span> </div>
                    ...
                    <div className="px-4">
                      ...
                      <p className="card-p">
                        ...
                        will win another cool NFT from the SUPERFAST.CARDS
                        Collection!
                      </p>
                    </div>
