...
import a from "../../Media/carbon_shop-new.png";
...
const Carbonleathercollection = () => {
  ...
  const mintNFT = async () => {
    try {
      const web3 = window.web3;
      const address = "0xA4BF8b6613aB391542E64D8f244Eb54004BFC689";
  ...
  const fetchData1 = async (urls) => {
    try {
        ...
        const responses = await Promise.all(validUrls.map((url) => axios.get(url)));
    ...
    <div>
      <div>
        <div className="shop-header px-5 d-flex  justify-content-end align-items-center">
          <h3>Carbon & Leather Collection</h3>
        </div>
        <div className="row py-4">
          ...
          <div className="col-lg-6 px-4 d-flex flex-column align-items-lg-end">
            ...
            <p className="garage-p-p mt-1">
              Buy them for 39 MATIC and get 250 PETROL in addition to your NFT!
            </p>
        ...
        <div className="row py-5 cards-container">
          <div className="col-5 col-lg-3 ">
            <div className="side-bar px-lg-4 ">
              ...
              >
                Cylinder {selectedCylinders.length ? "*" : ""}{" "}
                <IoIosArrowDown />
              </button>
              {cylinderMenu && (
                <div>
                  ...
                  >
                    <div className="data-card my-3 card-inner ">
                      ...
                      <div className="d-flex justify-content-center mt-1">
                        Mint now and get{" "}
                        <span className="span-pink mx-1"> 50 Petrol </span> in
                        return
                      </div>
...
export default Carbonleathercollection;
