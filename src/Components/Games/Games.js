      ...
      <div className="col-11 mx-auto mt-5">
        <div className="row mt-5">
          <div className="col-lg-6 p-2">
            ...
            <p>
              SUPERFAST.CARDS is more than a nice collection of collectible NFTs
              – it’s a fully playable car quartet game in which each NFT
            ...
            <div className="row mt-2">
              ...
              <div className="col-11">
                ...
                allows you to earn up to 100,000 PETROL a day with your cards –
            ...
            <div className="row mt-2">
              ...
              <div className="col-11">
                ...
                play for the cards or for PETROL – to win, of course.
              </div>
            </div>
