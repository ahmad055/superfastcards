  ...
  return (
   <div>
        ...
        <div className="col-11 px-5 mx-auto">
          <div className="row">
            ...
            <div className="col-lg-3 px-1">
              ...
              <p>
                Can you hardly wait for the launch of the Superfast.Cards Game,
              ...
              <p>
                ...
                machine, you only have to press the lever (resp. press the SPIN
                button) and the three cards spin in a circle. And of course, the
                result counts: if three of the same cards remain standing, then
                you have won a Superfast.cards NFT!
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="py-5  row">
        ...
        <ol>
            <li>Share the game on Twitter and Connect to Discord (this is the requirement to participate).</li>
            <li>
        Connect your MetaMask Wallet (necessary for you to receive your won NFT).
        </li>
        <li>
