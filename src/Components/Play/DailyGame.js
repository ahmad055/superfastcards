  ...
  return (
    <div className="daily-game">
        ...
        <div className="row">
          <div className="col-10 mx-auto px-2">
            ...
            <div className="d-flex justify-content-end mt-3">
                <h1>YOUR DAILY CHANCE TO WIN A SUPERFAST.CARDS NFT!</h1>
            </div>
            <div className="d-flex justify-content-end mt-4">
                <h5>Can you hardly wait for the launch of the Superfast.Cards Game? To shorten the waiting time for all of us, we have developed a little pre-launch game for you: the Superfast.Cards daily competition!</h5>
            </div>
            <div className="d-flex justify-content-end mt-4">
                <h5>The rules are very simple: Every day there is a different competition (eg. highest top speed or horsepower or lowest weight etc.). You can participate each day with one card from your set. Just select your card with the best value in the day's category below (you will already see the cards of the other participants below). At the end of the day, the card with the highest value will win another cool NFT from the Superfast.cards Collection.</h5>
            </div>
            <div className="d-flex justify-content-end mt-4">
      ...
      <div className="py-5  row">
        ...
        <ol>
            <li>You need to have some Superfast.Cards NFT ( Claim your free pack here )</li>
            <li>
        ...
        <li>Share on Twitter and get an extra boost () for your NFT Share on Twitter</li>
        </ol>
