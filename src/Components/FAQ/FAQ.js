    ...
    <div id="faq" className="mt-5 FAQ py-5">
      ...
      <div className="row">
        <div className="col-lg-9 px-2 mx-auto">
          ...
          >
            <p className="mt-3">What is Superfast.cards?</p>
            {iconone ? (
          ...
          {!iconone && (
            <div className="faq-inner-div px-3 py-3 d-flex justify-content-center  align-items-center ">
              <p>
                Superfast.cards is the first NFT Collectors Card Game with
          ...
          <div
            ...
            className="faq-main-div d-flex justify-content-between  align-items-center  px-2"
          >
            <p className="mt-3">Who is behind Superfast.cards?</p>
            {icontwo ? (
              <FaPlus className="plus-icon" />
            ) : (
              <FaMinus className="plus-icon" />
          ...
          <div
            ...
            className="faq-main-div d-flex justify-content-between  align-items-center  px-2"
          >
            <p className="mt-3">Tell me More about Superfast.cards?</p>
            {iconthree ? (
              <FaPlus className="plus-icon" />
            ) : (
              <FaMinus className="plus-icon" />
...
Each player plays with his own cards, i.e. the NFTs he owns – regardless of whether he is playing against the AI or against other players. This basic principle is always the same.
          ...
          <div
            ...
            className="faq-main-div d-flex justify-content-between  align-items-center  px-2"
          >
            <p className="mt-3">Where can i buy Superfast.Cards NFTs beside the Superfast.cards website?</p>
            {iconfive ? (
              <FaPlus className="plus-icon" />
            ) : (
              <FaMinus className="plus-icon" />
...
For all transactions through OpenSea, Superfast.cards receives a 10% commission.
          ...
          <div
            ...
            className="faq-main-div d-flex justify-content-between  align-items-center  px-2"
          >
            <p className="mt-3">Why can't i see my NFTs in my opensea account? </p>
            {iconsix ? (
              <FaPlus className="plus-icon" />
            ) : (
              <FaMinus className="plus-icon" />
          ...
          {!iconsix && (
            <div className="faq-inner-div px-3 py-3 d-flex flex-column  justify-content-center  align-items-center ">
              ...
              <p>Now let’s look at two common reasons NFTs are not visible on your OpenSea profile.</p>
              <p className="mt-4">
              1. YOUR CRYPTO WALLET (METAMASK) IS NOT CONNECTED CORRECTLY.
              </p>
              <ul>
                <li>Close out your browser, clear your cache, and try reconnecting.</li>
                <li>Do you have more than one crypto wallet?</li>
                <li>If so, make sure you are connecting to the correct wallet.</li>
              </ul>
              <p>2. YOU JUST COMPLETED A TRANSACTION AND YOU DON’T SEE THE NFT YOU JUST PURCHASED.</p>
              <p className="mt-2 mb-3">If there is high demand on the Ethereum blockchain, it could take more time to complete the transaction than anticipated. To double check, try looking up your transaction on Polyscan.</p>
              <p className="mt-5">https://support.opensea.io/hc/en-us/articles/1500003338421-Why-can-t-I-see-my-NFTs-in-my-account-</p>
            </div>
          )}
          <div
            onClick={() => {
            ...
            className="faq-main-div d-flex justify-content-between  align-items-center  px-2"
          >
            <p className="mt-3">How do i hide/unhide items from my OpenSea Profile?</p>
            {iconseven ? (
              <FaPlus className="plus-icon" />
            ) : (
              <FaMinus className="plus-icon" />
